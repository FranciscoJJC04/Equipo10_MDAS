...
public class Plato {
    ...
    public Plato(String nombre, float precio, TipoPlato tipo, TipoAcompanamiento acompanamiento) {
        ...
        if(acompanamiento == null){this.tipoAcompanamiento = TipoAcompanamiento.SIN_ACOMPANAMIENTO;} 
        else {this.tipoAcompanamiento = acompanamiento;}
    }
